...
const jonas =
  "I'm " + firstName + ', a ' + (year - birthYear1) + ' year old ' + job + '!';
console.log(jonas);

const jonasNew = `I'm ${firstName}, a ${year - birthYear1} year old ${job}!`; // template literals
...
const age3 = 18;
if (age3 === 18) console.log(`you just became ADULT :D`);
...
if (averageScoreDolphin > averageScoreKoalas) {
  console.log(
    `Team Dolphin with ${averageScoreDolphin} Points is the Winner!!!`
  );
...
if (averageScoreDolphin > averageScoreKoalas && aboveMinimumScoreDolphin) {
  console.log(
    `Team Dolphin with average points of ${averageScoreDolphin} Points is the Winner!!!`
  );
} else if (
  averageScoreKoalas > averageScoreDolphin &&
  aboveMinimumScoreKoalas
) {
  console.log(
    `Team Koalas with average points of ${averageScoreKoalas} Points is the Winner!!!`
  );
} else if (
  averageScoreDolphin === averageScoreKoalas &&
  aboveMinimumScoreDolphin &&
  aboveMinimumScoreKoalas
) {
  console.log(`Both Teams are Drawn!`);
} else {
  console.log(
    `Both Teams have less than 100 points so there are no eligable winners!`
  );
}
...
age4 >= 18
  ...
  : console.log('Cannot drink wine :(');

const drink = age4 >= 18 ? 'I can drink Wine 🍷🍷' : 'Cannot drink wine :(';
console.log(drink);

console.log(
  `So....   ${age4 >= 18 ? 'I can drink Wine 🍷🍷' : 'Cannot drink wine :('}`
);
